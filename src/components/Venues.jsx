...
const venues = [
  ...
  },
  {
    ...
    features: ['Modern Facilities', 'Professional Setup', 'Catering'],
  ...
  },
  {
    ...
    features: ['Saunas', 'Cold Plunge', 'Massage'],
    Logo: SaunaHouseLogo,
  },
  {
    name: 'Ellis Station',
    ...
    features: ['Grand Ballroom', 'Dance Floor', 'Premium Bar'],
  ...
  },
  {
    ...
    features: ['Luxury Rooms', 'Private Setting', 'Historic Charm'],
